...
<html>
	...
	<body style="background: url('images/1.jpg'); ">
		...
		<br>
		<h2>Hủy vé</h2>
		<h3 style='padding-left: 40px;'>Vé của bạn đã hủy thành công.<br><br>Số tiền &#x20b9; <?php echo $_SESSION['refund_amount']?> sẽ được hoàn trả vào tài khoản ngân hàng của bạn (Mất 15% giá trị hóa đơn).</td>
		</h3>
		<br>
	</body>
</html>